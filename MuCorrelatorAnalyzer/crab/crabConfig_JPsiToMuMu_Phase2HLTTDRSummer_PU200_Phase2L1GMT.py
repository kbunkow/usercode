...
config.General.requestName = 'Phase2L1GMT_org__MC_analysis_JPsiToMuMu_Summer20_PU200_t200'
...
config.Data.outputDatasetTag = 'Phase2L1GMT_org__MC_analysis_JPsiToMuMu_Summer20_PU200_t200'
